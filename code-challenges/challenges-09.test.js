...
function transformToLis(obj){
  // Solution code here...
  return Object.entries(obj).map(result => `<li>${result.join(': ')}</li>`)
...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((array, num) => array + num, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((item, cost) => item + cost.purchasePrice, 0);
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((array, counter) => array = counter++);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((objectArray, character) => {
    objectArray.push(character.name);
    return objectArray;
  }, []);
};
